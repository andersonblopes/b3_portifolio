...
LANGUAGES = {
    "English": {
        ...
        "total_bought": "Total ever bought (lifetime, incl. closed positions)",
        ...
        "kpi_total_profit": "Total profit (realized + dividends, net of fees)",
        ...
        "rec_hold": "🔵 HOLD",
        "rec_dca": "🟢 BUY (DCA)",
        "analysis_exec_summary_title": "Executive Summary",
        "analysis_math_title": "The Math of Recovery",
        "analysis_risk_section_title": "Risk Warning",
        "analysis_action_title": "Actionable Next Step",
        "analysis_rec_label": "Recommendation",
        "analysis_yoc_label": "Yield on Cost",
        "analysis_weight_label": "Portfolio Weight",
        "analysis_post_dca_weight": "Weight after DCA",
        "exec_exit": "Price has fallen through the cost-basis floor — this position is signalling an exit.",
        "exec_trim": "Position is significantly profitable; partial profit-taking is warranted.",
        "exec_hold_gain": "Position is in profit with no immediate action required.",
        "exec_hold_dividend": "Position is down, but the dividend yield on cost cushions the loss.",
        "exec_hold_concentration": "DCA would create excessive concentration; hold and monitor.",
        "exec_dca": "Position is at a loss; adding capital at current levels would improve the average.",
        "risk_exit_alert": "🚨 Price ({price}) is below the suggested stop ({stop}). Exit or place a hard stop immediately.",
        "risk_concentration": "⚠️ Concentration Risk: this DCA would push the asset to {weight:.1f}% of your portfolio (limit 10%).",
        "risk_sunk_cost": "⚠️ Sunk Cost Alert: down >30% — do not average down without revalidating the investment thesis.",
        "action_exit": "Exit the position or place a hard stop at {stop}.",
        "action_trim": "Place a sell order at the next profit target to lock in partial gains.",
        "action_hold": "Hold and monitor. No action required at current levels.",
        "action_hold_dividend": "Hold — yield on cost of {yoc:.1f}% offsets the unrealised loss.",
        "action_dca": "Invest {capital} to bring your average to {new_avg} — but only if you still believe in the investment thesis.",
        "action_dca_blocked": "Avoid DCA here — concentration risk is too high. Consider trimming other positions first.",
        # --- recommendation rationale (popover) + metric tooltips ---
        "rec_rationale_title": "ℹ️ Why this?",
        "rec_rationale_exit": "**EXIT** was triggered because:\n\n- Price fell below the trailing stop level\n- Dividend yield on cost is below 8% — no income cushion\n\nExit to prevent further capital erosion.",
        "rec_rationale_trim": "**TRIM** was triggered because:\n\n- Unrealised gain is ≥ 50% above your average buy price\n\nAt this profit level, locking in partial gains is prudent portfolio management.",
        "rec_rationale_hold": "**HOLD** was triggered because:\n\n- Position is in profit or at breakeven\n- No stop trigger and no excessive concentration detected\n\nNo action required. Reassess at the next rebalance.",
        "rec_rationale_hold_dividend": "**HOLD** (dividend override) was triggered because:\n\n- Price is below the trailing stop\n- But dividend yield on cost is ≥ 8%, which offsets the stop signal\n\nKeep the position while dividends remain healthy.",
        "rec_rationale_hold_concentration": "**HOLD** (concentration block) was triggered because:\n\n- Position is at a loss — DCA would normally be suggested\n- But adding capital would push this asset above 10% of portfolio\n\nAvoid DCA until you rebalance or grow the overall portfolio.",
        "rec_rationale_dca": "**BUY (DCA)** was triggered because:\n\n- Position is at a loss\n- At least one DCA scenario stays within the 10% concentration limit\n- Dividend yield on cost is below 8% (no cushion to justify holding as-is)\n\nAveraging down reduces your cost — only proceed if the thesis is still valid.",
        "metric_help_yield_pct": "Unrealised return relative to your average buy price.",
        "metric_help_breakeven": "Price at which you recover 100% of cost after deducting dividends received.",
        "metric_help_trailing_stop": "Suggested exit level. Always floored at your effective breakeven to avoid locking in a guaranteed loss.",
        "metric_help_yoc": "Total dividends received ÷ total cost. Values ≥ 8% activate the dividend cushion override.",
        "metric_help_weight": "This asset as a percentage of total portfolio market value.",
    ...
    "Português (Brasil)": {
        ...
        "total_bought": "Total comprado (histórico, incl. posições encerradas)",
        ...
        "kpi_total_profit": "Lucro total (realizado + proventos, líquido de taxas)",
        ...
        "rec_hold": "🔵 MANTER",
        "rec_dca": "🟢 COMPRAR (DCA)",
        "analysis_exec_summary_title": "Resumo Executivo",
        "analysis_math_title": "A Matemática da Recuperação",
        "analysis_risk_section_title": "Alerta de Risco",
        "analysis_action_title": "Próxima Ação",
        "analysis_rec_label": "Recomendação",
        "analysis_yoc_label": "Yield s/ Custo",
        "analysis_weight_label": "Peso na Carteira",
        "analysis_post_dca_weight": "Peso após DCA",
        "exec_exit": "O preço caiu abaixo do piso de custo — esta posição está sinalizando saída.",
        "exec_trim": "Posição altamente lucrativa; realização parcial de lucros é recomendada.",
        "exec_hold_gain": "Posição no lucro sem necessidade de ação imediata.",
        "exec_hold_dividend": "Posição em queda, mas o yield no custo amortece o prejuízo.",
        "exec_hold_concentration": "DCA criaria concentração excessiva; manter e monitorar.",
        "exec_dca": "Posição em prejuízo; aportar ao preço atual melhoraria o preço médio.",
        "risk_exit_alert": "🚨 Preço ({price}) abaixo do stop sugerido ({stop}). Sair ou colocar stop imediatamente.",
        "risk_concentration": "⚠️ Risco de Concentração: este DCA levaria o ativo a {weight:.1f}% da carteira (limite 10%).",
        "risk_sunk_cost": "⚠️ Custo Irrecuperável: queda >30% — não aporte sem revalidar a tese de investimento.",
        "action_exit": "Sair da posição ou colocar stop fixo em {stop}.",
        "action_trim": "Colocar ordem de venda no próximo alvo para garantir lucros parciais.",
        "action_hold": "Manter e monitorar. Nenhuma ação necessária no momento.",
        "action_hold_dividend": "Manter — yield no custo de {yoc:.1f}% compensa o prejuízo não realizado.",
        "action_dca": "Aportar {capital} para reduzir o PM a {new_avg} — somente se ainda acredita na tese.",
        "action_dca_blocked": "Evitar DCA aqui — risco de concentração elevado. Considere reduzir outras posições primeiro.",
        # --- recommendation rationale (popover) + metric tooltips ---
        "rec_rationale_title": "ℹ️ Por quê?",
        "rec_rationale_exit": "**SAÍDA** foi acionada porque:\n\n- Preço rompeu abaixo do stop móvel\n- Yield no custo abaixo de 8% — sem colchão de renda\n\nSaída para evitar erosão adicional de capital.",
        "rec_rationale_trim": "**REALIZAR** foi acionado porque:\n\n- Ganho não realizado ≥ 50% acima do preço médio\n\nNeste nível, realizar lucros parciais é gestão de risco prudente.",
        "rec_rationale_hold": "**MANTER** foi acionado porque:\n\n- Posição no lucro ou no equilíbrio\n- Sem stop ativo e sem concentração excessiva\n\nNenhuma ação necessária. Reavalie no próximo rebalanceamento.",
        "rec_rationale_hold_dividend": "**MANTER** (colchão de dividendos) foi acionado porque:\n\n- Preço abaixo do stop móvel\n- Mas yield no custo ≥ 8%, que compensa o sinal de stop\n\nManter enquanto os dividendos permanecerem saudáveis.",
        "rec_rationale_hold_concentration": "**MANTER** (bloqueio de concentração) foi acionado porque:\n\n- Posição em prejuízo — normalmente indicaria DCA\n- Mas aportar levaria o ativo acima de 10% da carteira\n\nEvite DCA até rebalancear ou crescer a carteira.",
        "rec_rationale_dca": "**COMPRAR (DCA)** foi acionado porque:\n\n- Posição em prejuízo\n- Pelo menos um cenário de DCA fica abaixo do limite de 10% de concentração\n- Yield no custo abaixo de 8% (sem colchão para manter como está)\n\nMédiar o custo reduz o PM — somente se a tese ainda for válida.",
        "metric_help_yield_pct": "Retorno não realizado em relação ao seu preço médio de compra.",
        "metric_help_breakeven": "Preço para recuperar 100% do custo após descontar dividendos recebidos.",
        "metric_help_trailing_stop": "Nível de saída sugerido. Sempre com piso no breakeven efetivo para evitar prejuízo garantido.",
        "metric_help_yoc": "Dividendos recebidos ÷ custo total. Valores ≥ 8% ativam o colchão de dividendos.",
        "metric_help_weight": "Este ativo como % do valor de mercado total da carteira.",
    ...
    "Español": {
        ...
        "total_bought": "Total comprado (histórico, incl. posiciones cerradas)",
        "market_value": "Valor de mercado",
        ...
        "kpi_total_profit": "Ganancia total (realizada + dividendos, neta de comisiones)",
        ...
        "rec_hold": "🔵 MANTENER",
        "rec_dca": "🟢 COMPRAR (DCA)",
        "analysis_exec_summary_title": "Resumen Ejecutivo",
        "analysis_math_title": "La Matemática de la Recuperación",
        "analysis_risk_section_title": "Alerta de Riesgo",
        "analysis_action_title": "Siguiente Paso",
        "analysis_rec_label": "Recomendación",
        "analysis_yoc_label": "Rendimiento s/ Costo",
        "analysis_weight_label": "Peso en Cartera",
        "analysis_post_dca_weight": "Peso tras DCA",
        "exec_exit": "El precio ha caído por debajo del piso de coste — la posición señala una salida.",
        "exec_trim": "Posición muy rentable; se recomienda toma de beneficios parcial.",
        "exec_hold_gain": "Posición en ganancias sin necesidad de acción inmediata.",
        "exec_hold_dividend": "Posición en pérdida, pero el rendimiento sobre coste amortigua la pérdida.",
        "exec_hold_concentration": "El DCA crearía concentración excesiva; mantener y vigilar.",
        "exec_dca": "Posición en pérdida; añadir capital al precio actual mejoraría el promedio.",
        "risk_exit_alert": "🚨 Precio ({price}) por debajo del stop sugerido ({stop}). Salir o colocar stop inmediatamente.",
        "risk_concentration": "⚠️ Riesgo de Concentración: este DCA llevaría el activo al {weight:.1f}% de la cartera (límite 10%).",
        "risk_sunk_cost": "⚠️ Coste Irrecuperable: caída >30% — no promediar sin revalidar la tesis de inversión.",
        "action_exit": "Salir de la posición o colocar stop fijo en {stop}.",
        "action_trim": "Colocar orden de venta en el siguiente objetivo para asegurar ganancias parciales.",
        "action_hold": "Mantener y vigilar. No se requiere acción en este momento.",
        "action_hold_dividend": "Mantener — rendimiento sobre coste de {yoc:.1f}% compensa la pérdida no realizada.",
        "action_dca": "Invertir {capital} para llevar el promedio a {new_avg} — solo si aún cree en la tesis.",
        "action_dca_blocked": "Evitar DCA aquí — riesgo de concentración demasiado alto. Considere reducir otras posiciones primero.",
        # --- recommendation rationale (popover) + metric tooltips ---
        "rec_rationale_title": "ℹ️ ¿Por qué?",
        "rec_rationale_exit": "**SALIDA** fue activada porque:\n\n- El precio rompió por debajo del stop móvil\n- Rendimiento sobre coste inferior al 8% — sin colchón de ingresos\n\nSalir para evitar mayor erosión del capital.",
        "rec_rationale_trim": "**REDUCIR** fue activado porque:\n\n- Ganancia no realizada ≥ 50% sobre el precio promedio\n\nA este nivel, asegurar ganancias parciales es gestión de riesgo prudente.",
        "rec_rationale_hold": "**MANTENER** fue activado porque:\n\n- Posición en ganancias o en equilibrio\n- Sin stop activo y sin concentración excesiva\n\nNo se requiere acción. Reevaluar en el próximo rebalanceo.",
        "rec_rationale_hold_dividend": "**MANTENER** (colchón de dividendos) fue activado porque:\n\n- Precio por debajo del stop móvil\n- Pero rendimiento sobre coste ≥ 8%, que compensa la señal de stop\n\nMantener mientras los dividendos sigan siendo saludables.",
        "rec_rationale_hold_concentration": "**MANTENER** (bloqueo de concentración) fue activado porque:\n\n- Posición en pérdida — normalmente sugeriría DCA\n- Pero añadir capital llevaría el activo por encima del 10% de la cartera\n\nEvitar DCA hasta rebalancear o hacer crecer la cartera.",
        "rec_rationale_dca": "**COMPRAR (DCA)** fue activado porque:\n\n- Posición en pérdida\n- Al menos un escenario de DCA se mantiene dentro del límite del 10% de concentración\n- Rendimiento sobre coste inferior al 8% (sin colchón para mantener)\n\nPromediar a la baja reduce el coste — solo si la tesis sigue siendo válida.",
        "metric_help_yield_pct": "Retorno no realizado relativo a su precio promedio de compra.",
        "metric_help_breakeven": "Precio para recuperar el 100% del coste tras descontar dividendos recibidos.",
        "metric_help_trailing_stop": "Nivel de salida sugerido. Siempre con piso en el punto de equilibrio efectivo para evitar pérdida garantizada.",
        "metric_help_yoc": "Dividendos recibidos ÷ coste total. Valores ≥ 8% activan el colchón de dividendos.",
        "metric_help_weight": "Este activo como % del valor de mercado total de la cartera.",
    ...
    "Français": {
        ...
        "total_bought": "Total acheté (historique, positions clôturées incl.)",
        ...
        "kpi_total_profit": "Profit total (réalisé + dividendes, net de frais)",
        ...
        "rec_hold": "🔵 CONSERVER",
        "rec_dca": "🟢 ACHETER (DCA)",
        "analysis_exec_summary_title": "Résumé Exécutif",
        "analysis_math_title": "La Mathématique du Redressement",
        "analysis_risk_section_title": "Alerte Risque",
        "analysis_action_title": "Étape Suivante",
        "analysis_rec_label": "Recommandation",
        "analysis_yoc_label": "Rendement s/ Coût",
        "analysis_weight_label": "Poids en Portefeuille",
        "analysis_post_dca_weight": "Poids après DCA",
        "exec_exit": "Le prix est tombé sous le plancher de coût — la position signale une sortie.",
        "exec_trim": "Position très rentable ; une prise de bénéfices partielle est recommandée.",
        "exec_hold_gain": "Position en gain sans action immédiate nécessaire.",
        "exec_hold_dividend": "Position en perte, mais le rendement sur coût amortit la perte.",
        "exec_hold_concentration": "Le DCA créerait une concentration excessive ; conserver et surveiller.",
        "exec_dca": "Position en perte ; investir au prix actuel améliorerait le prix moyen.",
        "risk_exit_alert": "🚨 Prix ({price}) en dessous du stop suggéré ({stop}). Sortir ou placer un stop immédiatement.",
        "risk_concentration": "⚠️ Risque de Concentration : ce DCA porterait l'actif à {weight:.1f}% du portefeuille (limite 10%).",
        "risk_sunk_cost": "⚠️ Coût Irrécupérable : baisse >30% — ne pas renforcer sans revalider la thèse d'investissement.",
        "action_exit": "Sortir de la position ou placer un stop fixe à {stop}.",
        "action_trim": "Placer un ordre de vente au prochain objectif pour sécuriser des gains partiels.",
        "action_hold": "Conserver et surveiller. Aucune action requise à ce stade.",
        "action_hold_dividend": "Conserver — rendement sur coût de {yoc:.1f}% compense la perte non réalisée.",
        "action_dca": "Investir {capital} pour ramener le prix moyen à {new_avg} — uniquement si la thèse reste valide.",
        "action_dca_blocked": "Éviter le DCA ici — risque de concentration trop élevé. Envisagez d'alléger d'autres positions d'abord.",
        # --- recommendation rationale (popover) + metric tooltips ---
        "rec_rationale_title": "ℹ️ Pourquoi ?",
        "rec_rationale_exit": "**SORTIE** a été déclenchée parce que :\n\n- Le prix a cassé en dessous du stop mobile\n- Rendement sur coût inférieur à 8% — pas de coussin de revenus\n\nSortir pour éviter une érosion supplémentaire du capital.",
        "rec_rationale_trim": "**ALLÉGER** a été déclenché parce que :\n\n- La plus-value latente est ≥ 50% au-dessus du prix moyen\n\nÀ ce niveau, sécuriser des gains partiels est une gestion de risque prudente.",
        "rec_rationale_hold": "**CONSERVER** a été déclenché parce que :\n\n- Position en gain ou à l'équilibre\n- Pas de stop actif ni de concentration excessive\n\nAucune action requise. Réévaluer lors du prochain rééquilibrage.",
        "rec_rationale_hold_dividend": "**CONSERVER** (coussin dividende) a été déclenché parce que :\n\n- Prix en dessous du stop mobile\n- Mais rendement sur coût ≥ 8%, qui compense le signal stop\n\nConserver tant que les dividendes restent solides.",
        "rec_rationale_hold_concentration": "**CONSERVER** (blocage concentration) a été déclenché parce que :\n\n- Position en perte — suggérerait normalement un DCA\n- Mais investir porterait l'actif au-dessus de 10% du portefeuille\n\nÉviter le DCA jusqu'à rééquilibrer ou faire croître le portefeuille.",
        "rec_rationale_dca": "**ACHETER (DCA)** a été déclenché parce que :\n\n- Position en perte\n- Au moins un scénario DCA reste sous la limite de concentration de 10%\n- Rendement sur coût inférieur à 8% (pas de coussin pour conserver)\n\nRéduire le coût moyen — uniquement si la thèse reste valide.",
        "metric_help_yield_pct": "Retour non réalisé par rapport à votre prix d'achat moyen.",
        "metric_help_breakeven": "Prix pour récupérer 100% du coût après déduction des dividendes reçus.",
        "metric_help_trailing_stop": "Niveau de sortie suggéré. Toujours au plancher de votre point mort effectif pour éviter une perte garantie.",
        "metric_help_yoc": "Dividendes reçus ÷ coût total. Valeurs ≥ 8% activent le coussin dividende.",
        "metric_help_weight": "Cet actif en % de la valeur de marché totale du portefeuille.",
